...
<section class="section intro">
    ...
    <div class="container">
        ...
        <form class="form" action="patremarks.php" method="post">
				<?php include('errors.php');?>
                    <label class="form-control">Session ID</label>
                    <input type="text" name="sid" value="<?=$sid?>" readonly/>
                    <div class="form-group">
                        <div class="col-xs-6">
                            <label for="description"><h4>Give Your Feedback</h4></label>
                            <textarea type="time" class="form-control" name="feed" required></textarea>
						</div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="col-xs-12">
                            <br>
                            <button class="btn btn-lg btn-success" style="width:98%;" type="submit" name="givefeedback"><i class="glyphicon glyphicon-ok-sign"></i> Give Feedback</button>
                        </div>
                    </div>
                </form>
        </div>
