<?php
    ...
    class myPDF extends FPDF{
        function header(){
            ...
            $this->Ln(20);
            $this->Cell(276, 10, 'ALL THE USERS REGISTERED IN THE SYSTEM',0,0,'C');
            $this->Ln(20);
        }
        function footer(){
            $this->SetY(-26);
        ...
        function viewUsers($db){
            ...
            while($data = $stmt->fetch(PDO::FETCH_OBJ)){
                ...
                $this->Cell(30,10,$data->fname,1,0,'L');
                $this->Cell(30,10,$data->lname,1,0,'L');
                $this->Cell(30,10,$data->idnumber,1,0,'L');
                $this->Cell(30,10,$data->tel,1,0,'L');
                $this->Cell(50,10,$data->email,1,0,'L');
                $this->Cell(30,10,$data->dob,1,0,'L');
                $this->Cell(30,10,$data->county,1,0,'L');
                $this->Ln();
            }
        }
